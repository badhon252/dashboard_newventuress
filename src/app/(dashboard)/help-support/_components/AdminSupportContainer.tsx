...
import { SupportData, DemoTableItemsType } from "./data";
...
function AdminSupportContainer() {
  ...
  return (
    <section className="w-full">
      ...
      <TableContainer data={SupportData} columns={SupportColumn} />
      </div>
...
const TableContainer = ({
  ...
  return (
    <div className="mt-[30px]">
      <DataTable table={table} columns={columns} title="Help & Support" />
    </div>
  );
};